...
flags = tf.app.flags
flags.DEFINE_string('graph_path', '', 'Path to frozen detection graph')
flags.DEFINE_string('label_path', '', 'Path to label file')
flags.DEFINE_string('test_image_dir', '', 'Path to test imgs and output diractory')
FLAGS = flags.FLAGS
